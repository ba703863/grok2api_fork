    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldVideoLastFrame: "可选尾帧图片引用（url 或 file_id），固定视频的最后一帧；仅 grok-imagine-video-1.5 的 Build/Console 路由支持。可单独使用，也可与 image 组合以同时固定首尾帧；提供后 prompt 可省略。",
    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldVideoLastFrame: "Optional last-frame image reference (url or file_id) that pins the final frame of the clip. Only Build/Console routes on grok-imagine-video-1.5 support it. Use it alone, or with image to pin both ends; prompt becomes optional.",
